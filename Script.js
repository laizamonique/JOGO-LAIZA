...
const playerSprite = new createjs.Sprite(100, 315, 65, 65);
const makimaSprite = new createjs.Sprite(500, 315, 65, 65);
...
const makimaAttackProbability = 0.7;
...
function playerAttack2() {
    if (!gameEnded) {
        ...
        // Inicie a animação de ataque do jogador
        playerSprite.gotoAndPlay("attack2");
